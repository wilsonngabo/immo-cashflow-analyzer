...
def main() -> None:
    ...
    # Supprime uniquement les annonces LBC achat (préserve bienveo + LBC location)
    conn.execute("DELETE FROM properties WHERE source='leboncoin' AND listingType='buy'")
    conn.commit()
