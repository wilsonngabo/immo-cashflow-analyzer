#!/usr/bin/env python3
"""Régions françaises (aligné avec src/lib/geography.ts)."""

# region name -> list of department codes
...
# noms de départements pour affichage (optionnel)
...
def region_slug(name: str) -> str:
    """Slug pour nom de fichier (ex: Île-de-France -> ile-de-france)."""
    import unicodedata
